...
public class AddJson {
	...
	public void sendEmails(String appURL){
		final String username = "haigopi@gmail.com";
		final String password = "Lenovo@123";
